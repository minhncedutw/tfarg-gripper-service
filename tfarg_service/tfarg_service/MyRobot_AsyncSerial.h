/*
*	The main function of this class is providing serial port communication (Kernel part)
*	Author: Wythe
*	Version: v1.4
...
#ifndef MYROBOT_ASYNCSERIAL_H
#define	MYROBOT_ASYNCSERIAL_H
 ...
 */
class MyRobot_AsyncSerialImpl;

/**
 * Asyncronous serial class.
 * Intended to be a base class.
 */
class MyRobot_AsyncSerial: private boost::noncopyable
{
public:
    MyRobot_AsyncSerial();
     ...
     * serial device
     */
    MyRobot_AsyncSerial(const std::string& devname, unsigned int baud_rate,
...
private:
    ...
    boost::shared_ptr<MyRobot_AsyncSerialImpl> pimpl;
 ...
 */
class MyRobot_CallbackAsyncSerial: public MyRobot_AsyncSerial
{
public:
    MyRobot_CallbackAsyncSerial();
    ...
    * serial device
    */
    MyRobot_CallbackAsyncSerial(const std::string& devname, unsigned int baud_rate,
    ...
    virtual ~MyRobot_CallbackAsyncSerial();
};

#endif //MYROBOT_ASYNCSERIAL_H